...
from .routers import account_center, ai_employees, jd_collection, jd_integrations, knowledge_center, metrics, stores, task_center, tiancang, users
...
HTML_PAGES = {
    ...
    "knowledge-center.html", "tiancang.html",
}
