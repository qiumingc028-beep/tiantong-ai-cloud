...
class Settings:
    def __init__(self):
        ...
        self.PUBLIC_SEARCH_PROVIDER = os.getenv("PUBLIC_SEARCH_PROVIDER", "").strip().lower()
        self.PUBLIC_SEARCH_MAX_QUERIES = _integer("PUBLIC_SEARCH_MAX_QUERIES", 5)
        self.PUBLIC_SEARCH_MAX_RESULTS_PER_QUERY = _integer("PUBLIC_SEARCH_MAX_RESULTS_PER_QUERY", 10)
        self.PUBLIC_RESEARCH_MAX_SOURCES = _integer("PUBLIC_RESEARCH_MAX_SOURCES", 20)
        self.PUBLIC_RESEARCH_DEFAULT_MIN_SOURCES = _integer("PUBLIC_RESEARCH_DEFAULT_MIN_SOURCES", 2)
        self.PUBLIC_RESEARCH_TIMEOUT_SECONDS = _integer("PUBLIC_RESEARCH_TIMEOUT_SECONDS", 120)
        self.PUBLIC_RESEARCH_ALLOWED_DOMAINS = _csv_list("PUBLIC_RESEARCH_ALLOWED_DOMAINS")
        self.PUBLIC_RESEARCH_BLOCKED_DOMAINS = _csv_list("PUBLIC_RESEARCH_BLOCKED_DOMAINS")
        self.PUBLIC_RESEARCH_MAX_TEXT_LENGTH = _integer("PUBLIC_RESEARCH_MAX_TEXT_LENGTH", 8000)
        self.PUBLIC_RESEARCH_MAX_CONCURRENT_SOURCES = _integer("PUBLIC_RESEARCH_MAX_CONCURRENT_SOURCES", 3)
