...
Evidence Gate最终Revision已从过期的0041校正为 `0042_v2_alpha_workflow_unique_constraints`。Path A固定为V1.0.1可运行基线Commit `483ebf560e1a4cfadecee4912a3ff6bca99516f6`和`0027_v1_schema_alignment`；Path B正式固定为可运行基线Commit `85586868bad3dd5d0fecba5f840383feccdc1c78`、Revision `0041_v2_alpha_migration_history_repair`。
